...
lab_lang= st.Page("Labs/LangChain_lab.py", title="Langchain", icon=":material/book_2:")

pg = st.navigation([hw_1, hw_2,hw_3, hw_4, hw_5, hw_7, lab_1, lab_2, lab_3, lab_4, lab_5, lab_lang])
